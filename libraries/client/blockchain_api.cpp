...
variant_object client_impl::blockchain_get_info() const
{
   ...
   info["account_reg_fee"]              = _chain_db->get_account_registration_fee();
   info["delegate_num"]                 = BTS_BLOCKCHAIN_NUM_DELEGATES;
   info["delegate_reg_fee"]             = _chain_db->get_account_registration_fee()
                                          + _chain_db->get_delegate_registration_fee();
